@extends('layouts.master') @section('title') nas services @endsection @section('css')
      ...
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         ...
         <div class="page-title-right">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="{{route('nas.index')}}">Nas</a></li>
   ...
   <div class="card">
      <div class="card-header border-bottom-dashed">
         <div class="d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1"><i class="ri-router-line text-success"></i> {{$nasName}} Services</h5>
         </div>
      </div>
         ...
         <div>
            ...
            <div class="noresult" style="display: block;">
               <div class="text-center">
                  ...
                  <p class="text-muted mb-0">This router has no associated services</p>
               </div>
            </div>
            @endif
            <!--end modal -->

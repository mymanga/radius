         ...
         <div class="card-body pt-0">
            <form action="{{route('message.bulk.send')}}" method="POST">
               ...
               <div class="modal-body">
                  <div class="mb-3">
                     <label for="phone" class="form-label">Client status <span
                  ...
                  <div class="mb-3" id="modal-id">
                     ...
                     <textarea name="message" id="message" cols="30" rows="5" maxlength="320" id="message" class="form-control @error('message') is-invalid @enderror"></textarea>
                     @error('message')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>

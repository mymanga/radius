@extends('layouts.master') @section('title') settings @endsection
@section('css')
@endsection
@section('content') @component('components.breadcrumb') @slot('li_1') Dashboard @endslot @slot('title') Settings @endslot @endcomponent 
@if (session('status'))

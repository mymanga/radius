            ...
            <div class="col-lg-12">
               <div class="card overflow-hidden">
                  <div class="row g-0">
                     ...
                     <img src="{{ URL::asset('assets/images/portal-login.png') }}" alt="" style="width: 100%;">
                     </div>
                     <!-- end col -->
                     <div class="col-lg-6">
                        <div class="p-lg-5 p-4">
                           ...
                           <div class="mt-4">
                              <form action="{{ route('customer.postAuth') }}" method="POST">
                                 @csrf
                                 <div class="mb-3">
            ...
            <div class="col-lg-12">
               <div class="text-center">
                  <script>
                     ...
                     class="mdi mdi-heart text-danger"></i> {{ setting('company') }}</p>
               </div>
            </div>
         </div>
      </div>

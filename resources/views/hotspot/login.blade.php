            ...
            <div style="margin-top:40px" class="container">
               <div class="row align-items-center gy-4">
                  <div class="col-lg-8 col-md-12 col-sm-7 col-12 ms-auto order-1 order-lg-2">
                     <div>
                        <img src="{{asset('images/full hd.jpg')}}" alt="" class="img-fluid">
                     </div>
                  </div>
                              ...
                              <div class="wrap animated fadeIn">
                                 <form name="login" action="{{$link_login_only}}" method="post" onSubmit="return doLogin()">
                                    ...
                                    <div class="input-group input-group-lg">
                                       <input name="username" type="text" value="{{$username}}" placeholder="Voucher code" class="form-control" id="code" onkeyup="return forceLower(this);" onblur="this.value=removeSpaces(this.value);" />
                                       <input name="password" type="hidden" placeholder="Password" />
                                       <button class="btn btn-outline-success" type="submit"><i class="ri-login-circle-line"></i> Connect</button>
                                    </div>
                                    <script>
            ...
            <div class="container">
               ...
               <div class="row gy-4">
                  <div class="col-lg-4">
                     <div>
                        <div class="mt-4">
                           <div class="ff-secondary fw-semibold">, <br/>{{setting('company_phone')}}<br/>{{setting('company_email')}}</div>
                        </div>
                     </div>
                  </div>
                  <!-- end col -->
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="mb-4">
                                    ...
                                    <input type="text" name="subject" class="form-control bg-light border-light" id="subject"
      ...
      <div class="modal fade" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="errorModalLabel" aria-hidden="true">
         <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  <small class="text-danger">Please input correct phone number</small>
               </div>
            </div>
         </div>
      </div>

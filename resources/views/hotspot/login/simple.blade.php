   ...
   <body class="">
            ...
            <div class="col-md-4 col-sm-4">
               <div class="panel panel-info packages text-center">
                  <div>
                     ...
                     @endphp
                     <button type="button" class="btn btn-warning btn-buy" data-toggle="modal" data-target="#purchaseVoucherModal" data-title="{{$plan->title}}" data-amount="{{$discounted_price}}" data-plan-id="{{$plan->id}}">PURCHASE <span class="text-title">{{$plan->title}}</span> </button>
                     @else
                     <button type="button" class="btn btn-warning btn-buy" data-toggle="modal" data-target="#purchaseVoucherModal" data-title="{{$plan->title}}" data-amount="{{$plan->price}}" data-plan-id="{{$plan->id}}">PURCHASE <span class="text-title">{{$plan->title}}</span> </button>
                     @endif
                  </div>
                  <br>
                  {{-- 
                  ...
                  <h3 class="month">
                     ...
                     <span class="ff-secondary">{{ $discounted_price }}</span> 
                  </h3>
      ...
      <div class="row">
         <div align="center" class="footer-text">
             <b>Phone:</b> {{setting('company_phone')}}<br/>

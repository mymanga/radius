...
// app/Gateways/UserDefined/pashaSmsGateway.php
    ...
    public static function getConfigParameters()
    {
        return [
            'gateway' => [
                'label' => 'Gateway',
                'type' => 'hidden',
                'name' => 'pasha_gateway', // Added name attribute
                'value' => setting("pasha_gateway"),
            ],
            'api_key' => [
                'label' => 'API Key',
                'type' => 'text',
                'name' => 'pasha_api_key', // Added name attribute
                'value' => setting('pasha_api_key'),
            ],
            'sender_id' => [
                'label' => 'Sender ID',
                'type' => 'text',
                'name' => 'pasha_sender_id', // Added name attribute

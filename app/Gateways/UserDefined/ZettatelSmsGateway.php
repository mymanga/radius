...
// app/Gateways/UserDefined/zettatelSmsGateway.php
    ...
    public static function getConfigParameters()
    {
        return [
            'gateway' => [
                'label' => 'Gateway',
                'type' => 'hidden',
                'name' => 'zettatel_gateway', // Added name attribute
                'value' => setting("zettatel_gateway"),
            ],
            'sender_id' => [
                'label' => 'Sender ID',
                'type' => 'text',
                'name' => 'zettatel_sender_id', // Added name attribute
                'value' => setting('zettatel_sender_id'),
            ],
            'user_id' => [
                'label' => 'User ID',
                'type' => 'text',
                'name' => 'zettatel_userid', // Added name attribute
                'value' => setting('zettatel_userid'),
            ],
            'password' => [
                'label' => 'Password',
                'type' => 'text',
                'name' => 'zettatel_password', // Added name attribute
                'value' => setting('zettatel_password'),
            ],
            'api_key' => [
                'label' => 'API Key',
                'type' => 'text',
                'name' => 'zettatel_api_key', // Added name attribute

...
// app/Gateways/UserDefined/CelcomSmsGateway.php
namespace App\Gateways\UserDefined;

class CelcomSmsGateway
{
    /**
     * Get information about the Celcom SMS gateway.
     *
     * @return array
     */
    ...
    public static function getConfigParameters()
    {
        return [
            'gateway' => [
                'label' => 'Gateway',
                'type' => 'hidden',
                'name' => 'celcom_gateway', // Added name attribute
                'value' => setting("celcom_gateway"),
            ],
            'api_key' => [
                'label' => 'API Key',
                'type' => 'text',
                'name' => 'celcom_api_key', // Added name attribute
                'value' => setting('celcom_api_key'),
            ],
            'partner_id' => [
                'label' => 'Partner ID',
                'type' => 'text',
                'name' => 'celcom_partner_id', // Added name attribute
                'value' => setting('celcom_partner_id'),
            ],
            'sender_id' => [
                'label' => 'Sender ID',
                'type' => 'text',
                'name' => 'celcom_sender_id', // Added name attribute
                'value' => setting('celcom_sender_id'),
            ],
            'api_endpoint' => [
                'label' => 'API Endpoint',
                'type' => 'select',
                'name' => 'celcom_api_endpoint', // Added name attribute
                'options' => [
                    'mysms' => 'mysms',
                    'isms' => 'isms',
                ],

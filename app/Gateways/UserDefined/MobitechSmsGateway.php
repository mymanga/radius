...
// app/Gateways/UserDefined/mobitechSmsGateway.php
    ...
    public static function getConfigParameters()
    {
        return [
            'gateway' => [
                'label' => 'Gateway',
                'type' => 'hidden',
                'name' => 'mobitech_gateway', // Added name attribute
                'value' => setting("mobitech_gateway"),
            ],
            'api_key' => [
                'label' => 'API Key',
                'type' => 'text',
                'name' => 'mobitech_api_key', // Added name attribute
                'value' => setting('mobitech_api_key'),
            ],
            'sender_id' => [
                'label' => 'Sender ID',
                'type' => 'text',
                'name' => 'mobitech_sender_id', // Added name attribute
